...
## Current version: 2.1.9.18
### Self bubble stabilization now uses a fixed custom overlay instead of the native self-bubble placement.
...
## Latest release
`https://github.com/ShiftyKiwi/ChatBubbles/releases/tag/v2.1.9.18`
