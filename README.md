...
## Current version: 2.1.9.20
### Self bubble handling has been reverted to the native bubble path while keeping the recent cleanup pass.
...
## Latest release
`https://github.com/ShiftyKiwi/ChatBubbles/releases/tag/v2.1.9.20`
