...
## Current version: 2.1.9.14
### Cleanup release with self bubble stabilization mode and updated plugin metadata.
...
## Latest release
`https://github.com/ShiftyKiwi/ChatBubbles/releases/tag/v2.1.9.14`
